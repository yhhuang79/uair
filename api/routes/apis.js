    ...
    .run(connection, function(err, cursor) {
      ...
      cursor.toArray(function(err, result) {
        ...
        for(var i = 0, ilen = result.length; i < ilen; i++){
          ...
          node['properties'] = {"PM2.5":result[i].s_d0,"TWD97Lon":gps_lon,"TWD97Lat":gps_lat,"SiteType":"LASS"};
